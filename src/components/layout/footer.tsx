...
const Footer = () => {
  useScrollToTop();
  return (
    <footer className={`mt-10 relative h-[530px] max-h-screen lg:h-[1024px] bg-brown-900 bg-footer-1 bg-no-repeat bg-cover bg-top lg:bg-top max-w-screen-xl m-auto transition-[background] duration-[90000ms] hover:bg-center lg:rounded-t-2xl`}>
