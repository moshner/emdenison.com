...
const Header = ({ scrollLink, children }: PropsWithChildren<Props>) => {
  return (
    <div className={`relative h-screen lg:h-96 bg-orange-950 bg-hero-reluctant-cyborg bg-no-repeat bg-cover bg-right-3 lg:bg-top-3 max-w-screen-xl m-auto transition-[background] duration-[20000ms] hover:bg-left motion-reduce:transition-none motion-reduce:hover:bg-right-3 lg:rounded-b-2xl`}>
