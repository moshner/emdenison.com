...
const Header = ({ scrollLink, children }: PropsWithChildren<Props>) => {
  return (
    <>
    <div className={`relative h-screen lg:h-96 bg-brown-900 bg-hero-1 bg-no-repeat bg-cover bg-top lg:bg-top-3 max-w-screen-xl m-auto transition-all duration-[5000ms] hover:bg-bottom`}>
      <TopNav />
