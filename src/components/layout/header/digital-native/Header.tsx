...
const Header = ({ scrollLink, children }: PropsWithChildren<Props>) => {
  ...
  return (
    <div className={`relative h-svh lg:h-96 bg-digital-native-bg bg-hero-digital-native bg-no-repeat bg-cover bg-top lg:bg-top-3 max-w-screen-xl m-auto transition-[background] duration-[20000ms] hover:bg-bottom motion-reduce:transition-none motion-reduce:hover:br-top lg:rounded-b-2xl`}>
